...
# Paths adjustment: .../tools/tests -> .../tools -> .../ (root) -> .../plugins/engineering-suite
PLUGIN_ROOT = Path(__file__).parent.parent.parent / "plugins" / "engineering-suite"
...
def test_plugin_json_structure():
    ...
    assert data["name"] == "engineering-suite"
