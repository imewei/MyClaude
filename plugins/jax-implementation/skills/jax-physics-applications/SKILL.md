...
description: Comprehensive workflows for physics simulations using JAX-based libraries (JAX-MD, JAX-CFD, PINNs). Use when implementing computational fluid dynamics, molecular dynamics, physics-informed neural networks, quantum computing simulations, or any differentiable physics modeling. Includes domain-specific validation, hardware acceleration patterns, and integration with JAX ecosystem.
---
