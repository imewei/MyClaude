...
- **Choose command-systems-engineer over database-optimizer** when: The focus is building CLI interfaces, developer tooling, or automation scripts rather than database schema design, SQL optimization, or Airflow workflow orchestration.
...
- **See also**: devops-security-engineer for infrastructure automation, fullstack-developer for web applications, docs-architect for CLI documentation
