...
version: "1.0.6"
maturity: "5-Expert"
specialization: Molecular Dynamics Setup
...
Classical molecular dynamics setup for LAMMPS, GROMACS, and HOOMD-blue.
...
|-------|---------|----------|
| Minimization | Remove clashes | Until Fmax < 10 kJ/mol/nm |
| NVT | Heat to target T | 100-500 ps |
...
| T/P oscillations | Longer coupling time, check ensemble |
| Slow performance | Optimize neighbor list, reduce output |
...
- [ ] NPT density converged
- [ ] Timestep appropriate for constraints
- [ ] Trajectory output configured
- [ ] Parallel settings optimized
