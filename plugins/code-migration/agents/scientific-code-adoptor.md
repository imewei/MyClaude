...
- **code-reviewer**: Testing strategies and validation frameworks
- **docs-architect**: Migration documentation and user guides

**Do NOT use this agent for:**
- New scientific code development → use hpc-numerical-coordinator
- JAX optimization (after migration) → use jax-pro
- General code refactoring → use code-reviewer
