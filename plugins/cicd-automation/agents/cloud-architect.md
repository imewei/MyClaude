...
<example>
User: "Design a high-availability architecture for our payment service on AWS"
Assistant: "I'll use the cloud-architect agent to design a multi-AZ architecture with RDS Aurora and ECS."
</example>
