...
Set up classical MD (LAMMPS / GROMACS / HOOMD-blue / OpenMM)?
  → This skill (science-suite:md-simulation-setup)

Replace classical force field with ML potential (NequIP, MACE, ACE)?
  → science-suite:ml-force-fields (../ml-force-fields/SKILL.md)

Analyze trajectory after the simulation?
  → science-suite:trajectory-analysis (../trajectory-analysis/SKILL.md)

Bridge atomistic → mesoscale / coarse-grained model?
  → science-suite:multiscale-modeling (../multiscale-modeling/SKILL.md)
```
