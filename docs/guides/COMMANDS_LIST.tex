...
\hypersetup{
    ...
    pdfsubject={Complete Command Catalog v1.0.4}
}
...
\fancyhead[R]{\small\color{secondarycolor}Complete Command List v1.0.8}
\fancyfoot[C]{\thepage}
...
\begin{titlepage}
    ...
    \begin{tcolorbox}[colback=tableheader,colframe=primarycolor,arc=3mm,boxrule=1pt]
        \centering
        \large
        \textbf{Total Commands:} 49 across 22 plugins\\[0.3cm]
...
\begin{itemize}
    ...
    \item \textbf{Total Resources:} 31 plugins \textbar\ 74 agents \textbar\ 48 commands \textbar\ 114 skills
...
All commands support execution modes (quick/standard/comprehensive).\\
