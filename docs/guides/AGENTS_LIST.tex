...
\fancyhead[R]{\small\color{secondarycolor}Complete Agent List v1.0.4}
\fancyfoot[C]{\thepage}
...
\begin{titlepage}
    ...
    \begin{tcolorbox}[colback=tableheader,colframe=primarycolor,arc=3mm,boxrule=1pt]
        ...
        \textbf{Version:} 1.0.4 \textbar\ \textbf{Last Updated:} December 3, 2025
    \end{tcolorbox}
...
\textit{This list was generated from v1.0.4 validated marketplace data\\
