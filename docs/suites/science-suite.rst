...
Consolidated suite for high-performance computing, specialized physics/chemistry simulations, ML/DL/HPC, and data science workflows. Features 96 specialized skills with extended context and adaptive reasoning for Claude Opus 4.6.
...
.. agent:: julia-ml-hpc
   :description: Expert in Julia ML, Deep Learning, and HPC. Lux.jl/Flux.jl neural networks, MLJ.jl pipelines, CUDA.jl GPU acceleration, KernelAbstractions.jl, Distributed.jl/MPI.jl cluster computing.
   :model: sonnet
   :version: 3.0.0

.. agent:: julia-pro
   :description: Expert in Julia scientific computing, SciML (DifferentialEquations.jl, ModelingToolkit.jl, Lux.jl for UDEs), Turing.jl, and nonlinear dynamics.
   :model: sonnet
   :version: 3.0.0
...
.. skill:: julia-neural-networks
   :description: Master Lux.jl and Flux.jl for deep learning in Julia. Covers explicit-parameter training loops, optimizers, data loading, and Flux-to-Lux migration.
   :version: 3.0.0

.. skill:: julia-neural-architectures
   :description: Design neural network architectures in Julia using Lux.jl. Covers Transformers, CNNs, RNNs/LSTMs/GRUs, autoencoders, and custom layer design.
   :version: 3.0.0

.. skill:: julia-training-diagnostics
   :description: Debug and diagnose neural network training in Julia. Covers gradient analysis, loss landscape, NaN detection, and Zygote/Enzyme debugging.
   :version: 3.0.0

.. skill:: julia-ad-backends
   :description: Select and debug AD backends in Julia. Covers Zygote.jl, Enzyme.jl, ForwardDiff.jl, custom ChainRulesCore rules, and DifferentiationInterface.jl.
   :version: 3.0.0

.. skill:: julia-ml-pipelines
   :description: Build ML pipelines in Julia with MLJ.jl for model selection and tuning, plus DrWatson.jl for experiment management and reproducibility.
   :version: 3.0.0

.. skill:: julia-gpu-kernels
   :description: Write high-performance GPU code in Julia with CUDA.jl and KernelAbstractions.jl. Covers custom kernels, shared memory, multi-GPU, and portable backends.
   :version: 3.0.0

.. skill:: julia-hpc-distributed
   :description: Scale Julia computations across clusters with Distributed.jl, MPI.jl, and SLURM job management. Covers multi-node data parallelism and AllReduce.
   :version: 3.0.0

.. skill:: julia-model-deployment
   :description: Deploy trained Julia models to production. Covers ONNX.jl export, Genie.jl/Oxygen.jl serving, PackageCompiler.jl sysimages, and Docker containerization.
   :version: 3.0.0

.. skill:: julia-graph-neural-networks
   :description: Build graph neural networks in Julia with GraphNeuralNetworks.jl and Lux.jl. Covers GCN, GAT, GraphSAGE, and mini-batch training.
   :version: 3.0.0

.. skill:: julia-reinforcement-learning
   :description: Implement reinforcement learning in Julia with ReinforcementLearning.jl. Covers DQN, PPO, A2C, DDPG, custom environments, and Lux.jl policy networks.
   :version: 3.0.0
